...
## Decisão
Event Sourcing com Event Store implementado no próprio PostgreSQL (Vide [ADR-001](https://github.com/alexandredorea/Challenge.CRM.Rommanel/blob/master/docs/ADR-001.md))
